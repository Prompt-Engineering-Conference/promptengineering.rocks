    ...
    <Layout home>
      ...
      <div className="major container live-container">
        <iframe
          ...
          src="https://www.youtube.com/embed/videoseries?si=WWADdZVHXZkhH0GR&amp;list=PLQEYbmzcCfpc4b9Z1zGd4waWwthP-PdmM"
          title="Prompt Engineering Conference 2024 playlist"
          frameborder="0"
      ...
      <div className="box bot container">
        ...
        <section className="prompt assistant">
          ...
          <h2>Event partners in the Asian region</h2>
          <div className="team clearfix">
            <div className="member">
            ...
            <div className="member">
              <img src="/images/team/gao_fei.jpg" alt="Gao Fei" />
              <h2>Gao Fei</h2>
              <small>Zhiding Tech Group CEO</small>
              <ul className="icons">
                <li>
                  <a
                    href="#"
